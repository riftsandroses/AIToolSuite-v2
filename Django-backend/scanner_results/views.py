...
class ScanResultsViewSet(viewsets.ViewSet):
    ...
    def _generate_artifact_file(self, prompt, output, scan_name, probe_name):
        """
        Generate a text file containing prompt and output
        """
        # Create a unique filename
        file_name = f"{scan_name}_{probe_name}_{uuid.uuid4().hex[:8]}.txt"
    ...
    def _create_excel_workbook(self, results, scan_name, client_name, client_app_name, scan_type):
        ...
        for row_num, result in enumerate(results, 2):
            # Generate artifact file for prompt and output
            ...
            row_data = [
                ...
                artifact_filename,  # Tester Artifacts
