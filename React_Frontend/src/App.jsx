    ...
    <ThemeProvider theme={darkTheme}>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route path="/api-pentest/scan/:scanId/API92023TC7" element={<UserAuth><API92023TC7 /></UserAuth>} />
          <Route path="/api-pentest/scan/:scanId/CustomTestingTC1" element={<UserAuth><CustomTestingTC1 /></UserAuth>} />
        </Routes>
      </Router>
    </ThemeProvider>
  );
