...
from .views import SSRFCompleteAnalysisView, SSRFAnalysisHistoryView,ExportSSRFResultsView,SSRFScanSummaryView
...
urlpatterns = [
    ...
    path('scans/<int:scan_id>/export/', ExportSSRFResultsView.as_view(), name='export-ssrf-results'),
    path('scans/<int:scan_id>/summary/', SSRFScanSummaryView.as_view(), name='scan-ssrf-summary'),
]
