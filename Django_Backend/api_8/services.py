...
class VulnerabilityScannerServiceTC3:
        ...
        try:
            ...
            for api in apis:
                try:
                    ...
                    vulns = self._test_api_for_verbose_errors(scan, api, jwt_token)
    ...
    def _test_api_for_verbose_errors(self, scan: ScanTC3, api: Dict, jwt_token: str) -> List[Dict]:
        ...
        for test_case in test_cases:
            try:
                ...
                # Log to history
                ScanHistoryTC3.objects.create(
                    scan=scan,  # Associate with the scan object
                    api_id=api['id'],
                    api_name=api['name'],
                    status='TESTED',
